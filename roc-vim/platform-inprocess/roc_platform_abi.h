...
typedef struct AnonStruct7fdf1427d56d5f0a AnonStruct7fdf1427d56d5f0a;

#if UINTPTR_MAX == UINT64_MAX
struct AnonStruct7fdf1427d56d5f0a {
    void* handle_bang;
    void* init_bang;
};
ROC_STATIC_ASSERT(sizeof(AnonStruct7fdf1427d56d5f0a) == 16, "AnonStruct7fdf1427d56d5f0a size mismatch");
ROC_STATIC_ASSERT(ROC_ALIGNOF(AnonStruct7fdf1427d56d5f0a) == 8, "AnonStruct7fdf1427d56d5f0a alignment mismatch");
ROC_STATIC_ASSERT(offsetof(AnonStruct7fdf1427d56d5f0a, handle_bang) == 0, "AnonStruct7fdf1427d56d5f0a.handle_bang offset mismatch");
ROC_STATIC_ASSERT(offsetof(AnonStruct7fdf1427d56d5f0a, init_bang) == 8, "AnonStruct7fdf1427d56d5f0a.init_bang offset mismatch");
#else
struct AnonStruct7fdf1427d56d5f0a {
    void* handle_bang;
    void* init_bang;
};
ROC_STATIC_ASSERT(sizeof(AnonStruct7fdf1427d56d5f0a) == 8, "AnonStruct7fdf1427d56d5f0a size mismatch");
ROC_STATIC_ASSERT(ROC_ALIGNOF(AnonStruct7fdf1427d56d5f0a) == 4, "AnonStruct7fdf1427d56d5f0a alignment mismatch");
ROC_STATIC_ASSERT(offsetof(AnonStruct7fdf1427d56d5f0a, handle_bang) == 0, "AnonStruct7fdf1427d56d5f0a.handle_bang offset mismatch");
ROC_STATIC_ASSERT(offsetof(AnonStruct7fdf1427d56d5f0a, init_bang) == 4, "AnonStruct7fdf1427d56d5f0a.init_bang offset mismatch");
#endif
...
#define HOSTED_IDX_HOST_EVAL 1
#define HOSTED_IDX_HOST_MESSAGE 2
#define HOSTED_IDX_HOST_REPLY 3
#define HOSTED_IDX_HOST_ID 4
...
/* Host.ex!: Str => {} */
extern void roc_vim_host_ex(RocStr arg0);

/* Host.eval!: Str => Str */
extern RocStr roc_vim_host_eval(RocStr arg0);

/* Host.message!: Str, Bool => {} */
extern void roc_vim_host_message(RocStr arg0, bool arg1);

/* Host.reply!: Str => {} */
extern void roc_vim_host_reply(RocStr arg0);

/* Host.id!: {} => Str */
extern RocStr roc_vim_host_id(void);


// Provided Symbols

/* Entrypoint: init_for_host! */
extern RocBox roc_vim_init(void);

/* Entrypoint: handle_for_host! */
extern RocBox roc_vim_handle(RocBox arg0, RocStr arg1);
...
typedef struct {
    ...
    HostedFn host_eval_bang;  /* index 1, C name: host_eval */
    HostedFn host_message_bang;  /* index 2, C name: host_message */
    HostedFn host_reply_bang;  /* index 3, C name: host_reply */
    HostedFn host_id_bang;  /* index 4, C name: host_id */
} HostedFunctions;
